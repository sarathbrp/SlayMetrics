#!/bin/bash
# ============================================================
# Round 2 — Reset DUT to Clean State
...
echo "=========================================="
echo "RESETTING DUT (ROUND 2) TO CLEAN STATE"
echo "=========================================="

# ─── STOP I/O PRESSURE PROCESS ──────────────────────────────
echo ">>> Stopping I/O pressure"
kill $(cat /tmp/io_pressure_pid 2>/dev/null) 2>/dev/null || true
rm -f /tmp/io_pressure_pid /tmp/io_pressure
